...
function JobSec3() {
  ...
  console.log("this is paginated", paginatedData, sortedData);
                  ...
                  <div className="wd-findjob-filer">
                    <div className="group-select-display">
                      ...
                      <p className="nofi-job">
                        <span>{sortedData?.length}</span> jobs recommended for
                        you
                      </p>
                    </div>
                    <SortBuy
            ...
            <ul className="pagination-job p-top">
              ...
              {currentPage < totalPages - 2 && (
                <>
                  ...
                  <li>
                    <Link to="#" onClick={() => handlePageChange(totalPages)}>
                      {totalPages}
                    </Link>
                  </li>
                </>
