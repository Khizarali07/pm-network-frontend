        ...
        <div className="row">
              ...
              <div className="thumb">
                ...
                <div className="trader-box box1 ani4">
                  ...
                  <div className="content">
                    ...
                    <div className="des">Job Posted</div>
                  </div>
                </div>
                <div className="trader-box box2 ani5">
                  ...
                  <div className="content">
                    ...
                    <div className="des">Job Matches Across 200+ Countries</div>
                  </div>
                </div>
                <div className="trader-box box3 ani4">
                  ...
                  <div className="content">
                    <h6 className="number">250K </h6>
                    <div className="des">active members</div>
                  </div>
                </div>
          ...
          <div className="col-lg-6 col-md-12 content-tab wow fadeInRight">
            <div className="wd-review-job contentbox1">
              ...
              <p>
                Our community is built for professionals who are laser-focused on results, ready to lead the future of Delivery and Execution in the tech sector.
              </p>
              <ul className="wd-list-icon">
                <li>
                  ...
                  <strong> Real-world Results:</strong> Enhance your career with proven tools, methodologies, and insights.
                </li>
                <li>
                  <span className="icon">
                    <svg
                  ...
                  <strong>  Tailored Growth Path:</strong> Learn, network, and advance with our unique mix of hands-on reviews, career development opportunities, and certification discounts.
                </li>
              </ul>
            </div>
          </div>
